...
public final class Constants {
	...
	public static final int INFO_PAPER_NUMS=5;
	public static String[] INFO_PAPER_TITLES={"基础资料","安全资料","许可信息","检查记录","备忘"};
	
	public static final int CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 100;
	public static final int CAPTURE_VIDEO_ACTIVITY_REQUEST_CODE = 200;
	public static final int CONTENT_GET_ACTIVITY_REQUEST_CODE = 300;
	
	public static final int SPINNER_ENTERPRISE_TYPE_ID=11;
	public static final int SPINNER_SAFETY_PERMIT_TYPE_ID=12;
	public static final int SPINNER_VARITY_TYPE_ID=13;
	public static final int SPINNER_DOCUMENT_TYPE_ID=14;
